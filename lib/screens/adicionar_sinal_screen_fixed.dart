...
class _AdicionarSinalScreenState extends State<AdicionarSinalScreen> {
  ...
  List<int> _diasSemana = [1]; // Padrão: segunda-feira
  bool _ativo = true;
  ...
  void _preencherCamposParaEdicao() {
    ...
    _horarioSelecionado = TimeOfDay.fromDateTime(sinal.dataHora);
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8),
                    const Text(
                      'Selecione os dias em que o alarme deve tocar',
  ...
  void _salvarSinal() async {
    ...
    try {
      ...
      // Criar uma data para hoje com o horário selecionado (será usado apenas para extrair hora/minuto)
